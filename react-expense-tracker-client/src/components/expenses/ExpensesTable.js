...
export default React.memo(function ExpensesTable({ expenses, handleDelete, handleUpdate }) {
    ...
    const Cell = (props) => {
        ...
        if (columnName === 'actions') {
            return (
                <ActionCell>
                    <IconButton size="small" onClick={() => showExpenseDialog(expense)} className={classes.iconBtn}>
                        <EditIcon color="primary" className={classes.icon} />
                    </IconButton>
                    <IconButton size="small" onClick={() => confirmDelete(expense)} className={classes.iconBtn}>
                        <DeleteIcon />
                    </IconButton>
                </ActionCell>
            )
